...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cloudflare-ai-image-generator
```

A live public deployment of this template is available at [https://cloudflare-ai-image-generator.templates.workers.dev](https://cloudflare-ai-image-generator.templates.workers.dev)
